...
public class LambdasAsArgumentsDemo {	
	...
	static String stringOp(LambdasAsArguments sf, String s) {
		return sf.func(s);
	}
	static String Str(String s) {
		LambdasAsArguments sf=(a) -> (a.toUpperCase());
		return sf.func(s);
	}
	public static void main(String args[]) {				
		...
		LambdasAsArguments reverse = (str) -> {
			String result = "";
			int i;
		...
		System.out.println(Str("Jai Mata Di"));
	}
}
